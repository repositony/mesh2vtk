...
impl From<CliVtkFormat> for ntools::mesh::vtk::VtkFormat {
    fn from(format: CliVtkFormat) -> Self {
        match format {
            CliVtkFormat::Xml => ntools::mesh::vtk::VtkFormat::Xml,
            CliVtkFormat::LegacyAscii => ntools::mesh::vtk::VtkFormat::LegacyAscii,
            CliVtkFormat::LegacyBinary => ntools::mesh::vtk::VtkFormat::LegacyBinary,
        }
    }
}
